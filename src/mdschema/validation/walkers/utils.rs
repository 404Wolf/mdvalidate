...
use crate::mdschema::validation::ts_utils::walk_to_root;
#[cfg(test)]
use crate::mdschema::validation::{errors::ValidationError, validator::Validator};
use mdvalidate_utils::PrettyPrint;

#[cfg(test)]
pub fn validate_str(schema: &str, input: &str) -> (Value, Vec<ValidationError>, Validator) {
    use crate::mdschema::validation::validator::ValidatorState;
