...
use crate::mdschema::validation::errors::{SchemaViolationError, ValidationError};
...
macro_rules! compare_node_kinds_check {
    (
        ...
        if let Some(error) = $crate::mdschema::validation::walkers::helpers::compare_node_kinds::compare_node_kinds(
            &$schema_cursor,
            &$input_cursor,
            $schema_str,
            $input_str,
...
#[cfg(test)]
mod tests {
    use crate::mdschema::validation::ts_utils::parse_markdown;
