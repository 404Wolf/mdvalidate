...
**Software** **developers** 
who are writing Markdown documents and want to ensure that they conform to a certain structure for reproducibility.

**AI**
- AI to both enforce a reproducible schema for an LLM and to generate Markdown documents from a schema and data. 
- AI for agentic behaviour, right now is done with JSON but markdown is more token efficient.
